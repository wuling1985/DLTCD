...
encoded1 = Dense(10, activation='sigmoid')(inputs)
encoded2 = Dense(5, activation='linear')(encoded1)
encoded3 = Dense(2, activation='sigmoid')(encoded2)
# "decoded" is the lossy reconstruction of the input
decoded2 = Dense(5, activation='linear')(encoded3)
...
#訓練神經網路
train_history = autoencoder.fit(X, X, epochs = 20000, batch_size = 3) #訓練回合數: 20000, 每3筆修正權重
...
#儲存模型
autoencoder.save('AE(sigmoid).h5')
autoencoder.save_weights("AE(sigmoid)_weights.h5")
...
numpy.savetxt("Result(AE+sigmoid).csv", predictions, delimiter=",")
